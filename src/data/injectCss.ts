...
/* Tạo kiểu dáng đẹp mắt cho nút click mã đơn hàng dưới dạng link chữ có gạch dưới */
.skyjet-btn {
...
/* Áp dụng font-size 11px và font-weight 500 cho các bảng trên 3 trang yêu cầu */
body.skyjet-custom-font-table table,
body.skyjet-custom-font-table table td,
body.skyjet-custom-font-table table th {
  font-size: 11px !important;
  font-weight: 500 !important;
}

/* Tô màu header bảng trên trang agent giống màu header erp */
body.skyjet-agent-host table thead tr th,
body.skyjet-agent-host table thead th {
  background-color: #2a3f54 !important;
  color: #ffffff !important;
}

/* Copy kiểu thiết kế table của ERP sang Agent */
body.skyjet-agent-host table {
  border-collapse: collapse !important;
  width: 100% !important;
...
body.skyjet-agent-host table th,
body.skyjet-agent-host table td {
  border: 1px solid #cbd5e1 !important;
  padding: 6px 8px !important;
  vertical-align: middle !important;
}

body.skyjet-agent-host table tbody tr:nth-of-type(odd) {
  background-color: #f9f9f9 !important;
}

body.skyjet-agent-host table tbody tr:nth-of-type(even) {
  background-color: #ffffff !important;
}

body.skyjet-agent-host table tbody tr:hover {
  background-color: #f1f5f9 !important;
}

/* Copy kiểu border cell bên agent sang erp (viền đầy đủ 4 cạnh cho từng ô) */
.jambo_table,
.jambo_table th,
.jambo_table td {
  border: 1px solid #cbd5e1 !important;
...
/* Force visible for custom extension columns to prevent them from being hidden by parent page script index-matching */
th[data-skyjet-channel-col="true"], td[data-skyjet-channel-col="true"],
th[data-skyjet-type-col="true"], td[data-skyjet-type-col="true"],
th[data-skyjet-time-col="true"], td[data-skyjet-time-col="true"],
th[data-skyjet-fare-col="true"], td[data-skyjet-fare-col="true"] {
